# Home Work 63. Розширені Концепції
...
**P.S. Щоб завести проєкт на webpack потрібно написати npm run build**

**Webpack використовувала, щоб прибрати помилку в console при використанні модулів (import, export).**